...
(FAO, 2021) while 15.0% of its population remains
...
and 0.0% versus nearest-NGO baseline, serving 9774
meals across 200 simulated events. Route optimization via
2-opt local search reduces travel distance by -12.8%
...
and 15.0% of the population remains undernourished (World
...
greedy initialization. -12.8% distance reduction over
greedy baseline.
...
15.0% (source: REAL: World Bank API). Preprocessing pipeline: KNN
...
nearest. Meals served: 9774. ANOVA: F=nan,
p=nan. Route improvement: -12.8% (p=0.0000).
...
0.0% waste reduction over random baseline, 9774
meals served, and -12.8% route efficiency improvement with
